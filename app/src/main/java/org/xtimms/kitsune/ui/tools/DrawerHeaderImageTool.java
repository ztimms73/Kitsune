...
import static org.xtimms.kitsune.R.id.imageView;
...
public class DrawerHeaderImageTool implements View.OnClickListener {
    ...
    public DrawerHeaderImageTool(AppCompatActivity activity, NavigationView navigationView) {
        ...
        mBackground = v.findViewById(imageView);
    ...
    public void initDrawerImage() {
        if(mImageFile.exists()) {
            mBackground.setImageBitmap(BitmapFactory.decodeFile(mImageFile.getPath()));
        } else {
            mBackground.setImageResource(R.drawable.side_nav_bar);
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case Crop.REQUEST_CROP: //crop
                ...
                Bitmap thumb = ThumbnailUtils.extractThumbnail(source, mBackground.getWidth(), mBackground.getHeight());
                source.recycle();
                //save to file
    ...
    private void beginCrop(Uri source) {
        ...
        Crop.of(source, destination)
                .withAspect(mBackground.getWidth(), mBackground.getHeight())
                .start(mActivity);
    }
