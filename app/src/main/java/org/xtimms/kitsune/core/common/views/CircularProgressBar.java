...
public class CircularProgressBar extends View {
    ...
    private final float[] circularData = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? new float[2] : null;
    private final float[] transientData = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? new float[2] : null;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (alpha > 0x00) {
                ...
                paint.setColor(ThemeUtils.getThemeAttrColor(getContext(), R.attr.colorAccent));
