...
public final class MangaDetails extends MangaHeader {
	...
	public MangaDetails(String name, String summary, String genres, String url, String thumbnail, String provider, int status, short rating, String description, String cover, String author, @NotNull MangaChaptersList chapters) {
	...
	public MangaDetails(long id, String name, String summary, String genres, String url, String thumbnail, String provider, int status, short rating, String description, String cover, String author, @NotNull MangaChaptersList chapters) {
